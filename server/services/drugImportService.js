    ...
    for (let i = startRow; i < rawRecords.length; i++) {
      ...
      if (!genObj) {
        ...
        genObj = {
          ...
          pharmacologicalClass: raw.pharmacologicalClass || 'Pharmacological Agent',
          prescriptionStatus: raw.prescriptionStatus || 'POM',
          indications: [],
          contraindications: [],
          dosageGuidance: { adult: 'As directed by physician', routes: ['Oral'] },
          doseAdjustment: { renal: 'None noted', hepatic: 'None noted' },
          adverseEffects: { common: [], uncommon: [], rare: [], seriousWarnings: [] },
          precautions: [],
          monitoringRequirements: [],
          foodInteractions: 'None reported',
          pregnancyInfo: { category: 'C', details: 'Evaluate risk-benefit' },
          breastfeedingInfo: { safety: 'caution', details: 'Caution advised' },
          paediatricConsiderations: 'Consult paediatrician',
          geriatricConsiderations: 'Standard monitoring',
          overdoseInformation: { symptoms: 'Symptomatic', management: 'Supportive care' },
          storageInformation: 'Store below 30°C in a dry place',
          sources: [{ organization: sourceName, title: 'Registered Ingestion', url: '', publicationDate: new Date().toISOString() }],
          medicalReview: {
            status: 'draft',
            reviewerName: 'Ingestion Engine',
            reviewerCredentials: 'MBBS Data Auditor',
