...
const COMMAND_ITEMS: CommandItem[] = [
  { id: 'dashboard', title: 'Dashboard Overview & Continue Reading', category: 'Navigation', view: 'dashboard', shortcut: 'HOME' },
  { id: 'study-materials', title: 'MBBS Study Materials (25 Subjects, Units, High-Yield Topics)', category: 'Study', view: 'study-materials', shortcut: 'STUDY' },
  { id: 'drug-reference', title: 'Bangladesh Drug Reference & DGDA Monographs', category: 'Pharmacology', view: 'drug-reference', shortcut: 'DRUGS' },
  { id: 'learn', title: 'Interactive Curriculum & BM&DC Modular Lessons', category: 'Learn', view: 'learn', shortcut: 'LEARN' },
  { id: 'textbook-library', title: 'Digital Textbook Library & E-Books', category: 'Library', view: 'textbook-library', shortcut: 'BOOKS' },
  { id: 'across-books', title: 'Study a topic across books: connected reading, comparison and notes', category: 'Learn', view: 'across-books' },
  { id: 'visual-lab', title: 'Visual Medicine & Diagnostics Engine (3D, DICOM, Wiggers, Microscopy)', category: 'Visual Lab', view: 'visual-lab', shortcut: 'VISUAL' },
  { id: 'visual-engine', title: 'The Visual Medicine Engine (12-Step Continuous Journey)', category: 'Visual Engine', view: 'visual-engine' },
  { id: 'practice', title: 'Practice Assessment & Clinical Exam Simulator (OSPE, OSCE, Viva)', category: 'Practice', view: 'practice', shortcut: 'EXAM' },
  { id: 'clinical-cases', title: 'Virtual Patient Clinical Cases & Bedside Workstation', category: 'Clinical Cases', view: 'cases', shortcut: 'CASES' },
  { id: 'revision', title: 'Saved Items & Smart Revision Mode', category: 'Revision', view: 'revision', shortcut: 'SAVED' },
  ...
  { id: 'textbook-reader', title: 'MBBS Digital Textbook & Clinical Pearl Annotations', category: 'Digital Textbook', view: 'textbook' },
  ...
  { id: 'precordial-exam', title: 'Clinical Examination: Precordium Bedside Simulator', category: 'Clinical Examination', view: 'clinical-exam' },
  ...
  { id: 'case-stemi', title: 'Virtual Patient Case: Acute Anterior STEMI', category: 'Clinical Cases', view: 'cases' },
